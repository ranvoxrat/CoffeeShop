...
import CoffeeManagementSystem.Accounts
import CoffeeManagementSystem.admin_start
import CoffeeManagementSystem.Inventory
# ============================================
    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                # ====== MENU BAR ==========
                menuBar_line = Canvas(product_page, width=1500, height=1.5, bg="#660066", highlightthickness=0)
                ...
                adm = Label(product_page, image=photo)
                adm.image = photo
                adm.place(x=1245, y=5)

                # admLabel = Label(product_page, text='ADMIN', font=('yu gothic ui', 18, 'bold'), fg='#ffc329', bg='#ffffff')
                ...
                product_button.place(x=180, y=15)
                ...
                logout_button = Button(product_page, text='Logout', bg='#f6f6f9', font=("", 13, "bold"), bd=0,
                                       ...
                                       cursor='hand2', activebackground='#fd6a36', activeforeground='#7a7a7a',
                                       command=logout)
                logout_button.place(x=1170, y=15)
                ...
                def add_coffee():
                    ...
                    try:
                        ...
                        messagebox.showerror("Error", f"Error adding coffee record: {str(e)}")
                ...
                self.button3.configure(background="#b30000")
                ...
                self.button4.configure(activebackground="#00cc99")
                ...
                self.button5.configure(background="#009933")
                ...
                self.button6.configure(background="#ff6600")
                ...
                def bill():
                    win = Toplevel()
                    CoffeeManagementSystem.Inventory.InventoryPage(win)
                    Manage_window.withdraw()
                    win.deiconify()
                ...
                def accounts():
                    win = Toplevel()
                    CoffeeManagementSystem.Accounts.InventoryPage(win)
                    Manage_window.withdraw()
                    win.deiconify()
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                admLabel = Label(biller, text='', font=('yu gothic ui', 18, 'bold'), fg='#ffc329', bg='#f6f6f9')
                ...
                logout_button = Button(biller, text='Logout', bg='#f6f6f9', font=("", 13, "bold"), bd=0,
                                       ...
                                       cursor='hand2', activebackground='#fd6a36', activeforeground='#7a7a7a',
                                       command=logout)
                logout_button.place(x=1230, y=15)
                ...
                self.button4.configure(cursor="hand2")
                self.button4.configure(foreground="#ffffff")
                self.button4.configure(background="#00cc00")
                self.button4.configure(font="-family {Poppins SemiBold} -size 10")
                self.button4.configure(borderwidth="0")
                ...
                self.button5.configure(cursor="hand2")
                self.button5.configure(foreground="#ffffff")
                self.button5.configure(background="#ff6600")
                self.button5.configure(font="-family {Poppins SemiBold} -size 10")
                self.button5.configure(borderwidth="0")
                ...
                self.button7.configure(background="#009933")
                ...
                self.button8.configure(background="#ff0000")
                ...
                self.button9.configure(background="#ff9933")
                ...
                btn_print = Button(top, text="""Print""", command=lambda: print_area(self.Scrolledtext1.get('1.0', END)),
                                   ...
                                   font="-family {Poppins SemiBold} -size 10", bg='#990099', activebackground="#ff6c38")
