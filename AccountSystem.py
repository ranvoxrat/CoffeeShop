...
import CoffeeManagementSystem.Guest
import CoffeeManagementSystem.Employee
import CoffeeManagementSystem.admin
import CoffeeManagementSystem.Dashboard
import CoffeeManagementSystem.admin_start
...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        brand_name = Label(landing_page, text=' COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("poppins", 15, "bold"))
        ...
        def open_guest():
            win = Toplevel()
            CoffeeManagementSystem.Guest.GuestPage(win)
            AccountSystem_window.withdraw()
            win.deiconify()

        def open_employee():
            win = Toplevel()
            CoffeeManagementSystem.Dashboard.FirstPage(win)
            AccountSystem_window.withdraw()
            win.deiconify()

        def open_admin():
            win = Toplevel()
            CoffeeManagementSystem.admin_start.FirstPage(win)
            AccountSystem_window.withdraw()
            win.deiconify()
        ...
        brand_name = Label(sign_in, text=' COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        ...
        heading = Label(sign_in, text="Sign In", font=("poppins", 40, "bold"), bg='#ffffff',fg="orangered")
        ...
        # ============================Username====================================
        # ========================================================================
        border_frame = Frame(sign_in, height=2, bg="#6b6a69")
        border_frame.place(x=380, y=216, width=290)

        username_label = Label(sign_in, text='Username', fg="#27221c", bg='#ffffff', font=("poppins", 12, "bold"))
        username_label.place(x=380, y=150)

        username_entry = Entry(sign_in, bg="#fafafa", fg="#6b6a69", font=("", 12, 'bold'), textvariable=StringVar())
        ...
        # ============================Password====================================
        # ========================================================================
        password_border_frame = Frame(sign_in, height=2, bg="#6b6a69")
        password_border_frame.place(x=380, y=282, width=290)

        password_label = Label(sign_in, text='Password', fg="#27221c", bg='#ffffff', font=("poppins", 12, "bold"))
        password_label.place(x=380, y=220)
        password_entry = Entry(sign_in, highlightthickness=2, relief=FLAT, bg="#fafafa", fg="#6b6a69", font=("poppins", 12), show="•",
                               textvariable=Password)
        password_entry = Entry(sign_in, bg="#fafafa", fg="#6b6a69", font=("", 12), show="•", textvariable=StringVar())
        password_entry.place(x=380, y=250, width=290, height=34)
        # password_entry.place(x=380, y=252, width=290, height=34)
        # password_entry.config(highlightbackground="#6b6a69", highlightcolor="black")

        loginButton = Button(sign_in, fg='#f8f8f8', text='Login', bg='#ff6c38', font=("poppins", 12, "bold"),
        ...
        createButton = Button(sign_in, fg='#f8f8f8', text='Create New Account', bg='#4286f5', font=("poppins", 12, "bold"),
        ...
        show_password.place(x=380, y=322)
        ...
        forgotPassword.place(x=540, y=322)
        ...
        brand_name = Label(sign_up, text=' COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)
